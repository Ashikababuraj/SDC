              ...
              <div class="card">
                <div class="card-body">
                  <div class="d-md-flex align-items-center">
                    <div>
                      <h4 class="card-title">Subcategory  Listing</h4>
                     
                    </div>
                    <div class="ms-auto mt-3 mt-md-0">
                      <a class="btn btn-primary d-flex align-items-center gap-1 " href="subcategories-add.php">
                    ...
                    <table class="table mb-0 text-nowrap varient-table align-middle fs-3">
                      <thead>
                        <tr>
                          ...
                          <th scope="col" class="px-0 text-muted">Subcategory Name</th>
                      ...
                      <tbody>
                        ...
                        <?php while($row = mysqli_fetch_assoc($result)): ?>
                          ...
                          <tr>
                              ...
                              <td class="px-0">
                                  <a href="subcategory-edit.php?id=<?= $row['id'] ?>" class="btn btn-sm btn-primary">Edit</a>
                                  <a href="subcategory-delete?id=<?= $row['id'] ?>" 
